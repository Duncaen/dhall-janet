...
(pp (parser/parse `foo ? bar ? fizz ? buzz`))
(pp (parser/parse `False || True`))
(pp (parser/parse `False || False || True`))
(pp (parser/parse `1 + 1`))
(pp (parser/parse `1 + 2 + 3`))
(pp (parser/parse `"A" ++ "B"`))
(pp (parser/parse `"A" ++ "B" ++ "C"`))
(pp (parser/parse `[1] # [2]`))
(pp (parser/parse `[1] # [2] # [3]`))
(pp (parser/parse `True && False`))
(pp (parser/parse `True && True && True`))
(pp (parser/parse `{=} /\ {=}`))
(pp (parser/parse `{=} /\ {=} /\ {=}`))
(pp (parser/parse `{=} // {=}`))
(pp (parser/parse `{=} // {=} // {=}`))
